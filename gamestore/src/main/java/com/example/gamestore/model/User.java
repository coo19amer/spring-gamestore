...
public class User implements UserDetails {
    ...
    @Length(max = 50, message = "Значение имени слишком длинное")
    private String firstName;
    @NotBlank(message = "Поле фамилии не может быть пустым")
    @Length(max = 50, message = "Значение фамилии слишком длинное")
    ...
    @Length(min = 8, message = "Пароль должен быть не меньше 8-ти символов")
